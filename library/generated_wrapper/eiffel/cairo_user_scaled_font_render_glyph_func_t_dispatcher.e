...
feature -- Access: Routine 
	...
	routine_1: detachable FUNCTION [TUPLE [a_scaled_font: POINTER; a_glyph: INTEGER; a_cr: POINTER; a_extents: POINTER], INTEGER] 
			--Eiffel routine to be call on callback.

	routine_2: detachable FUNCTION [TUPLE [a_scaled_font: POINTER; a_glyph: INTEGER; a_cr: POINTER; a_extents: POINTER], INTEGER] 
			--Eiffel routine to be call on callback.

	routine_3: detachable FUNCTION [TUPLE [a_scaled_font: POINTER; a_glyph: INTEGER; a_cr: POINTER; a_extents: POINTER], INTEGER] 
			--Eiffel routine to be call on callback.
...
feature -- Access: Callback
	...
	on_callback_1 (a_scaled_font: POINTER; a_glyph: INTEGER; a_cr: POINTER; a_extents: POINTER): INTEGER  
			-- Callback target.
		do
	...
	on_callback_2 (a_scaled_font: POINTER; a_glyph: INTEGER; a_cr: POINTER; a_extents: POINTER): INTEGER  
			-- Callback target.
		do
	...
	on_callback_3 (a_scaled_font: POINTER; a_glyph: INTEGER; a_cr: POINTER; a_extents: POINTER): INTEGER  
			-- Callback target.
		do
