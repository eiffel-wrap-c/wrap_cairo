...
class CAIRO_RECTANGLE_STRUCT_API
...
feature {NONE} -- Implementation wrapper for struct struct _cairo_rectangle

	sizeof_external: INTEGER 
		external
			"C inline use <eif_cairo.h>"
		alias
			"sizeof(struct _cairo_rectangle)"
		end
	...
	c_x (an_item: POINTER): REAL_64
		...
		alias
			"[
				((struct _cairo_rectangle*)$an_item)->x
			]"
		end
	...
	set_c_x (an_item: POINTER; a_value: REAL_64) 
		...
		alias
			"[
				((struct _cairo_rectangle*)$an_item)->x =  (double)$a_value
			]"
		ensure
	...
	c_y (an_item: POINTER): REAL_64
		...
		alias
			"[
				((struct _cairo_rectangle*)$an_item)->y
			]"
		end
	...
	set_c_y (an_item: POINTER; a_value: REAL_64) 
		...
		alias
			"[
				((struct _cairo_rectangle*)$an_item)->y =  (double)$a_value
			]"
		ensure
	...
	c_width (an_item: POINTER): REAL_64
		...
		alias
			"[
				((struct _cairo_rectangle*)$an_item)->width
			]"
		end
	...
	set_c_width (an_item: POINTER; a_value: REAL_64) 
		...
		alias
			"[
				((struct _cairo_rectangle*)$an_item)->width =  (double)$a_value
			]"
		ensure
	...
	c_height (an_item: POINTER): REAL_64
		...
		alias
			"[
				((struct _cairo_rectangle*)$an_item)->height
			]"
		end
	...
	set_c_height (an_item: POINTER; a_value: REAL_64) 
		...
		alias
			"[
				((struct _cairo_rectangle*)$an_item)->height =  (double)$a_value
			]"
		ensure
